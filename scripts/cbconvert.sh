...
python cbparse.py T 2 50 50 50 ../../chasebench/scenarios/deep/100/dependencies/ > ../../cbscenarios-star/deep/100/dependencies/program.star
...
python cbparse.py T 2 50 50 100 ../../chasebench/scenarios/correctness/tgds5/dependencies/ > ../../cbscenarios-star/correctness/tgds5/dependencies/program.star
...
python cbparse.py T 2 50 50 100 ../../chasebench/scenarios/correctness/weak/dependencies/ > ../../cbscenarios-star/correctness/weak/dependencies/program.star

mkdir -p ../../cbscenarios-star/correctness/tgds/data/
mkdir -p ../../cbscenarios-star/correctness/tgds/dependencies/
python cbparse.py S 2 ../../chasebench/scenarios/correctness/tgds/data/ > ../../cbscenarios-star/correctness/tgds/data/input.stream
python cbparse.py T 3 50 50 100 ../../chasebench/scenarios/correctness/tgds/dependencies/ > ../../cbscenarios-star/correctness/tgds/dependencies/program.star
